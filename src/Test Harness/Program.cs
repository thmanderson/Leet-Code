...
namespace AdventOfCode.Console
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Day 15
            int d15input1 = 722, d15input2 = 354;
            System.Console.WriteLine("Day 15, problem 1: " + DayFifteen.GeneratorCount(d15input1, d15input2, 40000000));
            System.Console.WriteLine("Day 15, problem 2: " + DayFifteen.SecondGeneratorCount(d15input1, d15input2, 5000000));

            // Day 16 - Part 1
            var d16input = ReadDaySixteenInput();
            char[] DancingPrograms = new char[] { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p' };
            DancingPrograms = DaySixteen.Dance(DancingPrograms, d16input);
            System.Console.WriteLine("Day 16, problem 1: " );
            foreach (char c in DancingPrograms) System.Console.Write(c);

            // Day 16 - Part 2
            DancingPrograms = new char[] { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p' };
            char[] d16p2output = DaySixteen.DanceLoop(DancingPrograms, d16input, 1000000000);
            System.Console.WriteLine("\nDay 16, problem 2: ");
            foreach (char c in d16p2output) System.Console.Write(c);

            // Day 17 - Part 1
            System.Console.WriteLine("Day 17, problem 1: " + Day17.Problem1(2017, 2017, 370));
            System.Console.WriteLine("Day 17, problem 2: " + Day17.Problem2(50000000, 370));
            ******************************************************************/

            // Day 18 - Part 1
            System.Console.WriteLine("Day 18, problem 1: " + Day18.Problem1(d18input));
        ...
        static string ReadDaySixteenInput()
        {
            string output = "";
            string line;

            using (StreamReader file = new StreamReader(@"C:\Users\B06551A\Documents\GitHub\first-steps\src\Advent of Code\Input Files\DaySixteenInput.txt"))
            {
                while ((line = file.ReadLine()) != null)
                {
                    output += line;
        ...
        public static string[] d18input = new string[]
        {
            "set i 31",
            "set a 1",
            "mul p 17",
